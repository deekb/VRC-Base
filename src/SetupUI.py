...
class SetupUI:
    def __init__(self, terminal, screen):
        ...
        self.ring_1_rotation_rad = self.ring_2_rotation_rad = self.ring_3_rotation_rad = 0
    ...
    def top_left_button_pressed(self):
        if self.screen_pressing:
            return (
                self.press_location[0] < Constants.button_size_x and
                self.press_location[1] < Constants.button_size_y
            )
        else:
            return False
    ...
    def top_right_button_pressed(self):
        if self.screen_pressing:
            return (
                    self.press_location[0] > Constants.screen_size_x - Constants.button_size_x
    ...
    def bottom_left_button_pressed(self):
        if self.screen_pressing:
            return (
                    ...
                    and self.press_location[1] > Constants.screen_size_y - Constants.button_size_y
            )
        else:
            return False
    ...
    def draw_button(self, file_name, position):
        if position == Constants.top | Constants.left:
            ...
            self.screen.draw_image_from_file(file_name, Constants.screen_size_x - Constants.button_size_x, 0)
        elif position == Constants.bottom | Constants.left:
            self.screen.draw_image_from_file(file_name, 0, Constants.screen_size_y - Constants.button_size_y)
        elif position == Constants.bottom | Constants.right:
            self.screen.draw_image_from_file(file_name, Constants.screen_size_x - Constants.button_size_x, Constants.screen_size_y - Constants.button_size_y)
    ...
    def handle_user_input(self):
        ...
        if self.page == -1 and self.top_left_button_pressed():
            ...
            if self.top_left_button_pressed():
                ...
                self.finished = True
            elif self.press_location[0] < Constants.screen_size_x / 2 and self.press_location[1] > Constants.screen_size_y / 2:
                self.robot_position = self.press_location
    ...
    def render_page(self):
        if self.page == -1:
            ...
            self.draw_button(Constants.deploy_directory + "Back_Button.bmp", Constants.top | Constants.left)
            ...
            self.draw_button(Constants.deploy_directory + "Start_Screen_No_Phosphorus.bmp", Constants.top | Constants.left)
            ...
            self.draw_button(Constants.deploy_directory + "Start_Button.bmp", Constants.bottom | Constants.right)
            ...
            self.draw_button(Constants.deploy_directory + "Team_Selection.bmp", Constants.top | Constants.left)
            self.draw_button(Constants.deploy_directory + "Back_Button.bmp", Constants.top | Constants.left)
            self.draw_button(Constants.deploy_directory + "Next_Button.bmp", Constants.top | Constants.right)
            ...
            if self.team == Constants.Team.red:
                self.draw_button(Constants.deploy_directory + "Robot_Placement_Selection_Red.bmp", Constants.top | Constants.left)
            elif self.team == Constants.Team.blue:
                self.draw_button(Constants.deploy_directory + "Robot_Placement_Selection_Blue.bmp", Constants.top | Constants.left)
            elif self.team == Constants.Team.skills:
                self.draw_button(Constants.deploy_directory + "Robot_Placement_Selection.bmp", Constants.top | Constants.left)
            self.draw_button(Constants.deploy_directory + "Back_Button.bmp", Constants.top | Constants.left)
            self.draw_button(Constants.deploy_directory + "Next_Button.bmp", Constants.top | Constants.right)
    ...
    def tick_page(self):
        ...
        if self.page == 2:
            if self.screen_pressing:
                ...
                self.draw_button(Constants.deploy_directory + "Back_Button.bmp", Constants.top | Constants.left)
                self.draw_button(Constants.deploy_directory + "Next_button.bmp", Constants.top | Constants.right)
                self.screen.draw_circle(self.robot_position[0], self.robot_position[1], 5)
